    ...
    <div style={theme}>
        <div class="accordion" id="accordionExample" >
            <div class="accordion-item"style={theme} >
                ...
                <div id="collapseOne" class="accordion-collapse collapse show" data-bs-parent="#accordionExample" style={theme}>
            ...
            <div class="accordion-item" style={theme}>
                ...
                <div id="collapseTwo" class="accordion-collapse collapse" data-bs-parent="#accordionExample" style={theme}>
            ...
            <div class="accordion-item" style={theme}>
                ...
                <div id="collapseThree" class="accordion-collapse collapse" data-bs-parent="#accordionExample" style={theme}>
                <div class="accordion-body">
            ...
            <button onClick={toggleTheme} style={{marginInline:"auto"}}>{themeButton}</button>
    </div>
  )
}
